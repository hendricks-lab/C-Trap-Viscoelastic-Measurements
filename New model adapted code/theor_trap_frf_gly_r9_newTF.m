...
%
%24July2023 - Ben
%           added kcyt2 to the u array - 9 index
%
%
...
i=sqrt(-1);
% u =  [Beta, GammaR, Alpha, k_trap, k_cyt0, kcyt2, k_cyt1, mass, nu];
uu=[u(1:2),0,u(4),0,0,0,u(8:9)]; %fz=0; (Ben) reindexed to include 9 
...
Pth_t=ps_r6_newTF(uu,fps,fsamp,Rbead,Zbead,kT,falias);
