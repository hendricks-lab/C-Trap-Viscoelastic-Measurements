% (Ben 2023) - addition of a kcyt2 term and reindexing the function 
...
%(Ben 2023) this is the denominator of the transfer function - added
%another term to represent the new model

g=ktrap + kcyt2 + kcyt0 + j.*w.*gamma_fps + (kcyt1.*(j.*w).^(alpha))./gamma(alpha); %g=6*pi*R*G 
